...
export const students = [ { Timestamp: '2020/10/16 2:37:13 PM GMT+1',
    ...
    '8-Quels sont tes films/séries préférées ?': 'Prison Break',
    ...
    '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
    ...
    { Timestamp: '2020/10/16 2:37:18 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Avengers',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 2:39:33 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Breaking bad',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 2:39:53 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Peaky blinders, Breaking bad, Inception, interstellar',
    ...
    { Timestamp: '2020/10/16 2:40:04 PM GMT+1',
        ...
        '5-Quelles sont les associations de l\'ensim qui t’intéresse ?':
            'BDE;Cultu;Infographie;MAO;ENSIMIEN;ENSIM is running;VASI;ENSIM\'Elec',
        '5-Plutôt...': 'Android',
        '6-Quel est ton personnage de fiction préféré ?': 'Luffy',
        '7-Que fais-tu de ton temps libre ?': 'Ne3ess',
        '8-Quels sont tes films/séries préférées ?': 'Peaky Blinders, Got, les animes en general',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;C++;HTML5 CSS;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu;Régulièrement',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Régulièrement',
    ...
    { Timestamp: '2020/10/16 2:40:23 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Rick et morty',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 2:40:30 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Peaky Blinders, Daredevil, inception',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 2:40:32 PM GMT+1',
        ...
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'Java;C;HTML5 CSS;Php;Python;JavaScript;Assembleur',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Jamais',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
        '11-As-tu déjà utilisé ? [Linux]': 'Un peu',
        '11-As-tu déjà utilisé ? [Mac]': 'Jamais',
        '11-As-tu déjà utilisé ? [Windows]': 'Régulièrement',
    ...
    { Timestamp: '2020/10/16 2:40:53 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Steven universe',
    ...
    { Timestamp: '2020/10/16 2:41:13 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'En series stranger things et the oa',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;HTML5 CSS;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Régulièrement',
    ...
    { Timestamp: '2020/10/16 2:41:30 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Battle Royale , Star Wars , Marvel ',
        '9-Quel est ton navigateur préféré ?': 'Opera;Opéra GX ( c pour les gamers ) ',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'Java;C;C++;C#;HTML5 CSS;Php;Python;JavaScript;Assembleur',    '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Régulièrement',
        '11-As-tu déjà utilisé ? [Linux]': 'Régulièrement',
        '11-As-tu déjà utilisé ? [Mac]': 'Jamais',
        '11-As-tu déjà utilisé ? [Windows]': 'Tout le temps',
    ...
    { Timestamp: '2020/10/16 2:41:39 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Retour vers le futur / Hunger games / ...',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
    ...
    { Timestamp: '2020/10/16 2:43:08 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?':
            'Umbrella Academy, End of the fucking World, Orphan Black Gatsby le magnifique ',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;HTML5 CSS;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Tout le temps',
    ...
    { Timestamp: '2020/10/16 2:45:32 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Out of Africa/Peaky Blinders',
    ...
    { Timestamp: '2020/10/16 2:45:43 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'The magicians, dark, into the wild, Amélie Poulain',
    ...
    { Timestamp: '2020/10/16 2:49:36 PM GMT+1',
        ...
        '5-Quelles sont les associations de l\'ensim qui t’intéresse ?':
            'BDE;BDLC;Jensim;Infographie;GALA;KFET;Trublions du Plateau;ENSIM\'Elec',
        '5-Plutôt...': 'Android',
        ...
        '7-Que fais-tu de ton temps libre ?':
            'Discuter, dessiner, écrire, grimper, nager, lire, ecouter de la musique (beaucoup), glander, des maths, jeux videos, roller, VTT, courir, penser, observer, aider, traîner sur YouTube...',
    ...
    { Timestamp: '2020/10/16 2:51:32 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?':
            'Altered Carbon, Black Mirror, Shutter Island, Minority Report',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
    ...
    { Timestamp: '2020/10/16 3:00:47 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Des film d\'action',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 3:04:00 PM GMT+1',
        ...
        '4-As-tu déjà passé le TOEIC ? Tu peux mettre ton score dans autre': 'Non',
        '5-Quelles sont les associations de l\'ensim qui t’intéresse ?':
            'BDE;BDLC;Cultu;Jensim;Infographie;MAO;GALA;ENSIMIEN;KFET;ENSIM is running;K\'verne;Trublions du Plateau;VASI;ENSIM\'Elec;Abobinables',
        '5-Plutôt...': 'Android',
        '6-Quel est ton personnage de fiction préféré ?': 'Naruto',
        '7-Que fais-tu de ton temps libre ?':
            'Uhm uhm you know .... ...................................................des animes manhwas mangas league of legends',
        '8-Quels sont tes films/séries préférées ?': 'The wolf of wallstreet / Dark',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 3:04:28 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Breaking Bad, The Walking Dead, Game of Thrones. ',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/16 3:56:57 PM GMT+1',
        ...
        '7-Que fais-tu de ton temps libre ?':
            'Sortir,dormir,améliorer mes compétences dans ce que j’aime faire, créer des apllications',
        '8-Quels sont tes films/séries préférées ?': 'Breaking bad',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 4:09:09 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Solo leveling,jhon wick',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
    ...
    { Timestamp: '2020/10/16 4:13:13 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Interstellar',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
    ...
    { Timestamp: '2020/10/16 4:13:15 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'The catch',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/16 4:27:28 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?':
            ' Series Marvel, films CAT8, films Hunger Games, films divergente, ',
    ...
    { Timestamp: '2020/10/16 4:45:57 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Fiche club/friend',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;C++',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/16 5:01:40 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Seigneur des Anneaux, Game of Thrones, Viking',
    ...
    { Timestamp: '2020/10/16 5:07:18 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Seigneur des Anneaux, Doctor Who',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C;HTML5 CSS;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/16 5:34:23 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Star wars, One piece, HxH',
    ...
    { Timestamp: '2020/10/21 2:52:01 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Aucuns',
    ...
    { Timestamp: '2020/10/21 5:08:45 PM GMT+1',
        ...
        '4-As-tu déjà passé le TOEIC ? Tu peux mettre ton score dans autre': 'Non',
        '5-Quelles sont les associations de l\'ensim qui t’intéresse ?':
            'BDE;BDLC;MAO;ENSIMIEN;K\'verne;VASI;ENSIM\'Elec;Abobinables',
        '5-Plutôt...': 'Android',
        '6-Quel est ton personnage de fiction préféré ?': 'Rick Deckard',
        '7-Que fais-tu de ton temps libre ?': 'Plein de choses',
        '8-Quels sont tes films/séries préférées ?': 'Westworld, The eternal sunshine of the spotless mind',
        '9-Quel est ton navigateur préféré ?': 'Firefox',
    ...
    { Timestamp: '2020/10/21 5:23:28 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Westworld, Handmaid\'s Tale, Dexter...',
    ...
    { Timestamp: '2020/10/21 5:29:00 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Got /Breaking bad /Lucifer/Peaky blinders/',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'C++;Python',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Un peu',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/22 10:55:16 AM GMT+1',
        ...
        '7-Que fais-tu de ton temps libre ?': 'Sport',
        '8-Quels sont tes films/séries préférées ?': 'Casa de papel',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
        '10-Quel langage de programmation as-tu déjà utilisé ?': 'Java;C;HTML5 CSS;Php;Python;JavaScript;Assembleur',
        '11-As-tu déjà utilisé ? [Une carte Arduino/Raspberry]': 'Jamais',
        '11-As-tu déjà utilisé ? [Des logiciels de retouche (Paint, Photoshop)]': 'Un peu',
    ...
    { Timestamp: '2020/10/22 6:08:10 PM GMT+1',
        ...
        '8-Quels sont tes films/séries préférées ?': 'Élite ',
        '9-Quel est ton navigateur préféré ?': 'Chrome',
